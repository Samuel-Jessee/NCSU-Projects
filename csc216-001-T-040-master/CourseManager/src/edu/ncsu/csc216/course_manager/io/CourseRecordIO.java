...
/**
 * Reads and writes Course information from files, and uses information from
 * files to create new Courses.
 * 
 * @author SamuelJessee
 *
 */
public class CourseRecordIO {
	...
	/**
	 * Reads Course records from the given file. If the file doesn't exist a
	 * FileNotFoundException is thrown. A line with a format error will be
	 * ignored.
	 * 
	 * @param fileName
	...
	/**
	 * Creates a Course from the String record. An IllegalArgumentException is
	 * thrown if one of the items is missing or if the Course cannot be
	 * constructed.
	 * 
	 * @param courseLine
	 *            the line to process
