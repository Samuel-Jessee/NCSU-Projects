...
/*
 * Creates a table in database for fitness data.
 * 
 * author: Samuel Jessee (sijessee)
 */
CREATE TABLE fitness(
	fitness_id		BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
	patient_id		BIGINT UNSIGNED NOT NULL,
	fitness_date	DATE NOT NULL,
	cal_burned		INT unsigned,
	steps			INT unsigned,
	distance		DOUBLE unsigned,
	floors			INT unsigned,
	min_sedentary	INT unsigned,
	min_light		INT unsigned,
	min_fair		INT unsigned,
	min_very		INT unsigned,
	act_cal			INT unsigned,
	low_hr			INT unsigned,
	high_hr			INT unsigned,
	average_hr		INT unsigned,
	act_hours		INT unsigned,
	min_uv			INT unsigned,
