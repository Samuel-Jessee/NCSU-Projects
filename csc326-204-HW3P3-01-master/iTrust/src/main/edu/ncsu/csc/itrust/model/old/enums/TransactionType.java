...
/**
 * All of the possible transaction types, in no particular order, used in
 * producing the operational profile. TransactionCode -- identification code
 * Description -- basic description of the event ActionPhrase -- a
 * patient-centered English sentence describing the action (used in activity
 * feeds) PatientViewable -- boolean for if the action will be displayed in the
...
public enum TransactionType {
	...
	/** DEMOGRAPHICS_EDIT */
	// Set to false as per the requirements page for UC43 as it is not supposed
	// to be shown for LHCP or DLHCP
	...
	;
	/**
	 * This string is used in the SQL statement associated with pulling events
	 * for display in a patient's Access Log
	 */
	...
	/**
	 * This string is used in the SQL statement associated with excluding events
	 * as specified in UC43
	 */
