...
CREATE TABLE childbirths(
	...
	patientMID BIGINT UNSIGNED NOT NULL,
	pitocin DOUBLE,
	nitrousOxide DOUBLE,
	pethidine DOUBLE,
	epiduralAnaesthesia DOUBLE,
	magnesiumSulfate DOUBLE,
	rhimmuneglobulin DOUBLE,
	method varchar(50) NOT NULL,
	childrenids varchar(40) NOT NULL,
	cbdate TIMESTAMP NOT NULL,
	PRIMARY KEY (visitID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID)
) ENGINE=MyISAM;

CREATE TABLE childreninchildbirth(
...
CREATE TABLE previousPregnancyInfo(
	amtChildren INT NOT NULL,
	deliveryType INT UNSIGNED NOT NULL DEFAULT '0',
	hoursInLabor INT NOT NULL,
	infoID BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID BIGINT UNSIGNED NOT NULL,
	weeksPreg INT NOT NULL,
	weightGained INT NOT NULL,
	year INT NOT NULL,
	PRIMARY KEY (infoID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID)
) ENGINE=MyISAM;

CREATE TABLE obstetricsInitialization(
	oDate DATE NOT NULL,
	EDD DATE NOT NULL,
	LMP DATE NOT NULL,
	patientMID BIGINT UNSIGNED NOT NULL,
	...
	PRIMARY KEY (visitID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID),
	RhNeg BOOLEAN NOT NULL) ENGINE=MyISAM;
...
CREATE TABLE ultrasound(
	...
	HL DOUBLE NOT NULL,
	EFW DOUBLE NOT NULL,
	ultraID BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID BIGINT UNSIGNED NOT NULL,
	PRIMARY KEY (ultraID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID)
) ENGINE=MyISAM;

CREATE TABLE obstetricsofficevisit(
	oDate DATE NOT NULL,
	numWeeks INT NOT NULL,
	weight DOUBLE NOT NULL,
	bloodPressure varchar(10) NOT NULL,
	FHR INT NOT NULL,
	numFetus INT NOT NULL,
	lowLyingPlacenta BOOLEAN NOT NULL,
	ultrasound varchar(20),
	visitID BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID BIGINT UNSIGNED NOT NULL,
	picture MEDIUMBLOB,
	highgenetic BOOLEAN NOT NULL,
	complications varchar(200),
	PRIMARY KEY (visitID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID)
) ENGINE=MyISAM;

CREATE TABLE patientgooglecal(
	calendar varchar(40),
	calID BIGINT UNSIGNED NOT NULL AUTO_INCREMENT,
	patientMID BIGINT UNSIGNED NOT NULL,
	PRIMARY KEY (calID),
	FOREIGN KEY (patientMID) REFERENCES patients(MID)
) ENGINE=MyISAM;
...
CREATE TABLE fitnessinfo(
	...
	ActiveHours int,
	UVExposure int,
	Patient BIGINT unsigned NOT NULL COMMENT 'MID of the Patient',
	HCP BIGINT unsigned NOT NULL COMMENT 'MID of the HCP'
) ENGINE=MyISAM;
