...
DROP TABLE IF EXISTS fitnessinfo;
...
DROP TABLE IF EXISTS childreninchildbirth;
...
DROP TABLE IF EXISTS obstetricsInitialization;
DROP TABLE IF EXISTS obstetricsofficevisit;
DROP TABLE IF EXISTS officeVisit;
DROP TABLE IF EXISTS patients;
DROP TABLE IF EXISTS patientgooglecal;
...
DROP TABLE IF EXISTS previousPregnancyInfo;
