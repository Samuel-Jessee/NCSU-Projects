...
public class TestDataGenerator {
	...
	/**
	 * Generate test data for uc93 acceptance scenarios
	 * 
	...
	/**
	 * Generates test data for uc94 acceptance scenarios
	 * 
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
	 */
	public void uc94() throws FileNotFoundException, SQLException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/uc94.sql");
	}

	/**
	 * Generates test data for uc96 acceptance scenarios
	 * 
	 * @throws FileNotFoundException
	 * @throws SQLException
	 * @throws IOException
