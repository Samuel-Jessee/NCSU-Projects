...
//	VIEW_INITIAL_OBSTETRICS_RECORD(6301, "View Initial Obstetric Record", "View Initial Obstetric Record", true),
	...
	/** VIEW LABOR AND DELIVERY REPORT **/
	VIEW_LABOR_REPORT(9500, "View Labor and Delivery Report", "View Labor and Delivery Report", true),
	
	/**CREATE CHILDBIRTH VISIT**/
	CREATE_CHILDBIRTH(9600, "Create Childbirth Visit", "Create Childbirth Visit", true),
	/** ADD CHILDBIRTH DRUGS **/
	ADD_CHILDBIRTH_DRUGS(9601, "Add childbirth drugs", "Add childbirth drugs", true),
	/** A BABY IS BORN **/
	BABY_BORN(9602, "A baby is born", "A baby is born", true),
	/** CREATE BABY RECORD **/
	CREATE_BABY(9603, "Create baby record", "Create baby record", true),
	/** EDIT CHILDBIRTH VISIT **/
	EDIT_CHILDBIRTH(9604, "Edit Childbirth Visit", "Edit Childbirth Visit", true)
	;
