...
public class SessionUtils {
	...
	/**
	 * Get the current obstetric initialization id that the user (HCP) is viewing.
	 */
	private static final String OBSTETRIC_INITIALIZATION_ID = "obstetricInitializationId";
	...
	public Object getCurrentObstetricsInitializationId() {
		return parseLong(getSessionVariable(OBSTETRIC_INITIALIZATION_ID));
	}
}
