...
<%
	...
	List<PersonnelBean> allHCP = personnelDAO.getAllHCP();
	String msg = "";
...
<form action="appointmentRequests.jsp" method="post">
	...
	<select name="lhcp">
		<%
			for (PersonnelBean personnel : allHCP) {
		%><option
			<%if (personnel.getMID() == hcpid)
					out.print("selected='selected'");%>
			value="<%=personnel.getMID()%>"><%=personnel.getFullName()%></option>
		<%
			}
		%>
	</select>
