...
<div align=center>
	    <table class="fTable" align=center>
	      <tr>
	      	<th colspan=2 >Personnel Information</th></tr>
	      	<tr>
	     	...
	     	<tr >
				...
				<td>
					<input name="roleString"  value="<%= StringEscapeUtils.escapeHtml("" + (personnelForm.getRoleString())) %>"  type="text">
	     		</td>
	     	</tr>
	      	<tr>
	      		<td class="subHeaderVertical">
	      	...
	      	<td>
				<input name="phone"  value="<%= StringEscapeUtils.escapeHtml("" + (personnelForm.getPhone())) %>"  type="text">
	      	</td>
	      </tr>
	      <tr>
	      	<td class="subHeaderVertical">
	      ...
	      <tr>
	      	...
	      	<td>
				<input name="zip"  value="<%= StringEscapeUtils.escapeHtml("" + (personnelForm.getZip())) %>"  type="text">
	      	</td>
	      </tr>
		  <tr>
