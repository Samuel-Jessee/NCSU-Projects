...
public interface CustomerAccountManager
{
    ...
    * @throws IllegalStateException if a customer or the administrator is
    *            already logged in
    ...
    * @throws IllegalStateException if the database is full or the administrator
    *            is not logged in
    * @throws IllegalArgumentException if customer with given id is already in
    *            the database
    */
