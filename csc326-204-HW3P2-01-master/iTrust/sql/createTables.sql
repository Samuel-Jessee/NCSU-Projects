...
CREATE TABLE fitness(
	fitness_id				BIGINT unsigned AUTO_INCREMENT primary key,
	...
	floors					INT unsigned,
	minutes_sedentary		INT unsigned,
	minutes_light			INT unsigned,
	minutes_fair			INT unsigned,
	minutes_very			INT unsigned,
	active_calories			INT unsigned
) ENGINE=MyISAM; 
