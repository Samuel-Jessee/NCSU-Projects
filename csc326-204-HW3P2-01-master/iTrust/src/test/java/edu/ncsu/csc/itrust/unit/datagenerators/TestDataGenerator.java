...
public class TestDataGenerator {
	...
	/**
	 * Based on previous data generator for UC68 that included data on Patient
	 * Derek Morgan, Patient Jennifer Jareau, Patient Aaron Hotchner, and HCP
	 * Spencer Reid that was also used for patient representatives and other
	 * tests
	 */
	...
	/**
	 * Inserts fitness data into the system for multiple days and patients.
	 * 
	 ...
	 * @throws IOException
	 */
	public void fitnessData() throws SQLException, FileNotFoundException, IOException {
		new DBBuilder(factory).executeSQLFile(DIR + "/fitnessData.sql");
	}
