...
/**
 * Interface for states in the Bug State Pattern. All concrete bug states must
 * implement the BugState interface.
 * 
...
public interface BugState {
	...
	/**
	 * Update the {@link TrackedBug} based on the given {@link Command}. An
